...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-09-2022 a las 23:36:06
...
INSERT INTO `areas` (`idA`, `nombreA`) VALUES
...
(11, 'Camilo Lopez', 'camilo0618@gmail.com', 'M', 1, 0, 'dxsfsdfsaxvfxcs');
...
--
ALTER TABLE `empleado`
  ADD CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`area_id`) REFERENCES `areas` (`idA`) ON DELETE CASCADE ON UPDATE CASCADE;
